...
content = r"""Main Flask application for the hostel-complaints project.

Provides:
- complaint submission with optional image upload
- generation of a short access code for reporters to track status
- admin UI (login, list, status updates, export)
- `/track` public endpoint to check complaint status using id+access_code
"""
